...
import sty from "./PlasmicButton.module.css"; // plasmic-import: ll3hHBC03oBt/css
...
export type PlasmicButton__VariantsArgs = {
  ...
  color?: SingleChoiceArg<
    ...
    | "link"
  >;
  lavender?: SingleBooleanChoiceArg<"lavender">;
};
  ...
  const stateSpecs: Parameters<typeof useDollarState>[0] = React.useMemo(
    () => [
      ...
      },
      {
        ...
        type: "private",
        variableType: "variant",
        initFunc: ({ $props, $state, $queries, $ctx }) => $props.lavender
      }
    ],
    [$props, $ctx, $refs]
  );
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg___0K5Mo)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__hA6Lg)}
                role={"img"}
              />
            ),
