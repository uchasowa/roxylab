...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: ZRml-k__Ofyf/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg___2SwZw)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__b7Fg1)}
              role={"img"}
            />
          ),
