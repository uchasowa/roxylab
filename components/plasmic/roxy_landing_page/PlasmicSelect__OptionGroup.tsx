...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: rCrg3zvpL5_T/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: vycrmcvmfIp5/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__vyM4Z)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__kKX)}
              />
            </React.Fragment>
          ),
          value: args.children
